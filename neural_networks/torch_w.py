...
class Nuron:
    def __init__(self,inp=1,out=1,lr=0.001,act='ReLU'):
        ...
        self.B = torch.zeros(out, requires_grad=True)
        self.lr = lr
        self.act = act
